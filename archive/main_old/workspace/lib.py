...
from phlab.workspace import *
from model.inputp import *
from model.kernelsp import *
from visual.graphicsp import *
from model.specp import *
import os
import json
from tqdm import tqdm
from timeit import default_timer as time

class create_workspace(object):
    """docstring for create_workspace."""

    def __init__(self):
        super(create_workspace, self).__init__()
        self.nws=1
        self.nmodel=0
        self.nexp=0
