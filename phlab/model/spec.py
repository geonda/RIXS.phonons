...
class spec(object):
    ...
    def __init__(self,dict,nruns=1,nmodel=1,out_dir='./_output/' ):
        ...
        self.spec_raw = out_dir+'model_{nm}/{nr}_rixs_raw.csv'.format(nm=nmodel,
                                                                        nr=nruns)
        ...
        self.save_noel=\
            self.out_dir+'model_{nm}/{nr}_rixs_phonons.csv'.format(nm=nmodel,
                                                                    nr=nruns)
        self.save_full=\
            self.out_dir+'model_{nm}/{nr}_rixs_full.csv'.format(nm=nmodel,
                                                                nr=nruns)
